...
async function restoreDatabase(){
  ...
  // Never overwrite a live local database on every Render start. A local DB
  // may contain writes made after the last remote snapshot. Restore only when
  // this instance does not already have a usable database.
