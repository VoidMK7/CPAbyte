...
function App(){
  ...
  const menuItems=[
    ["home","Dashboard"],["home","Earn"],["wallet","Wallet"],["referrals","Referrals"],["profile","Profile"],
...
function AdminPage({setToast}){
  ...
  const load=async()=>{
    try{
      ...
      const [td,ud,wd,sd,ad,apps,roleData]=results.map(r=>r.status==="fulfilled"?r.value:null);
